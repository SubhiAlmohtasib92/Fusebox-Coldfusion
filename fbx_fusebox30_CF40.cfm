...
<fusedoc fuse="FBX_FUSEBOX301_CF40.CFM" specification="2.0">
	...
	<properties>
		...
		<history author="John Quarto-vonTivadar" date="27 Sep 2001" email="jcq@mindspring.com">Portions of code contributed by Steve Nelson, Hal Helms, Jeff Peters, Nat Papovich, Patrick McElhaney, Fred Sanders, Bill Wheatley and Stan Cox.</properties>
 ...
 fb_.fu2a.urlcount=fb_.fu2a.urlcount+1){
	...
	if (refindnocase("[[:alpha:]]",left(trim(fb_.fu2a.urlname),1)) 
	 and not isdefined("attributes." & fb_.fu2a.urlname))
		structinsert(attributes,fb_.fu2a.urlname,evaluate("attributes." & fb_.fu2a.urlname));}
